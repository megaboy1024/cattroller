...
Pong = {
  ...
  onkeydown: function(keyCode) {
    switch(keyCode) {
      ...
      case 1:    alert("hello"); if (!this.leftPaddle.auto)  this.leftPaddle.moveUp();    break;
      case 2:    if (!this.leftPaddle.auto)  this.leftPaddle.moveDown();  break;
      case 3:    if (!this.rightPaddle.auto) this.rightPaddle.moveUp();   break;
      case 4:    if (!this.rightPaddle.auto) this.rightPaddle.moveDown(); break;
    }
  },
  ...
  hello:       function(on) {alert("ON pong!!") },
  player1up: function(on) {this.leftPaddle.moveUp(); sleep(1000);this.leftPaddle.stopMovingUp() },
  player1down: function(on) {this.leftPaddle.moveDown() ; sleep(1000);this.leftPaddle.stopMovingDown()},
  player2up: function(on) {this.rightPaddle.moveUp(); sleep(1000);this.rightPaddle.stopMovingUp() },
  player2down: function(on) {this.rightPaddle.moveDown() ; sleep(1000);this.rightPaddle.stopMovingDown()},
